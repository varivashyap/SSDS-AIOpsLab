...
wsk action create hoteltimelineservice --docker $DOCKER_IMAGE --memory 512 --timeout 600000

# (Optional) Invoke the action
# wsk action invoke hoteltimelineservice --blocking --result --param input_data "test input"
