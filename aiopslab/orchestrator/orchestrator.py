...
class Orchestrator:
    ...
    async def ask_env(self, input):
        ...
        try:
            ...
            return str(e)
        print("api_name:", resp["api_name"])
        print("args:", resp["args"])
        print("kwargs:", resp["kwargs"])
    ...
    async def start_problem(self, max_steps: int):
        ...
        for step in range(max_steps):
            ...
            # If the env_response is an error, increment the error count
            if isinstance(env_response, str) and "error" in env_response.lower():
                error_count += 1
            ...
            if env_response == SubmissionStatus.VALID_SUBMISSION:
                ...
                error_count += 1
                print("Invalid submission! Error Count:", error_count)
